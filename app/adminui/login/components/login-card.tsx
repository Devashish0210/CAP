...
export default function LoginCard() {
    ...
    const handleGenerateOTP = async (e) => {
        ...
        try {
            const response = await fetch('https://alumniapi.microland.com/adminui/generate-otp', {
                method: 'POST',
                headers: {
    ...
    const handleValidateOTP = async (e) => {
        ...
        try {
            ...
            const otpResponse = await fetch('https://alumniapi.microland.com/adminui/validate-otp', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
            ...
            if (otpResponse.ok) {
                ...
                const adminCheckResponse = await fetch('https://alumniapi.microland.com/adminui/is-allowed', {
                    method: 'POST',
                    headers: {
                        'X-EMAIL': email,
                        'X-OTP': otp
