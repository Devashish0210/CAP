export const documents: DocumentListTypes = {
    "Financial Documents": [
        ...
        { label: "Form 16", description: "Please click on the request button to email your Form 16 to your email address ", note: "Form 16 for the last Financial Year during your employment at Microland" },
    ...
    "Exit Documents": [
        { label: "Full and Final Statement", description: "Please click on the request button to email your Full and Final Statement to your email address " },
        ...
        { label: "Relieving Letter", description: "Please click on the request button to email your Relieving Letter to your email address" },
    ]
};
