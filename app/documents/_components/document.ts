export const documents: DocumentListTypes = {
    ...
    "Exit Documents": [
        { label: "Full and Final Statement", description: "Please click on the request button to email your Full and Final Statement to your email address,", note: "Once the NDC process is closed, you can access your Full and Final settlement here." },
        { label: "Service Letter", description: "Please click on the request button to email your Service Letter to your email address", note: "In case of Involuntary exits, your No Dues Clearance will be sent to your email address." },
